...
AZURE_STORAGE_ACCOUNT_CONTAINER_NAME = os.getenv("AZURE_STORAGE_ACCOUNT_KNOWLEDGE_BASE_CONTAINER_NAME")

#############
# Get current search index name
#############
def getSearchIndexName():
    return AZURE_SEARCH_INDEX_NAME
