        ...
        try {
            ...
            if (error.response) {
                if (error.response.status === 409) {
                    ...
                    alert("This index name is already in use. Please choose a different one.");
                }
            }
            else {
                ...
                <div className="flex flex-col gap-5 mt-5 p-5 items-center">
                    ...
                    />
                        <div className="flex flex-row gap-3 justify-center items-center content-center">
                            <button className="px-3 py-1 bg-bg-tertiary text-white rounded hover:bg-bg-secondary"
